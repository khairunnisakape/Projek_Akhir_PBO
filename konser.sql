...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2023 at 12:35 PM
...
INSERT INTO `tiket` (`id_tiket`, `seat`, `harga`, `stok`) VALUES
(7, 'bronze', 2000, 3);
...
--
ALTER TABLE `tiket`
  MODIFY `id_tiket` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
